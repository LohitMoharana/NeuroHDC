...
│   ├── tb/                       # Testbenches
│   ├── vivado/                   # Bit-true verification framework
...
| **hw/** | Synthesizable RTL, cocotb verification (tb/), Vivado FPGA project (vivado/), and physical ASIC implementation (asic/). |
